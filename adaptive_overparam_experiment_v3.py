"""
adaptive_overparam_experiment_v3.py
...
CONFIG = {
    ...
    'epochs_per_phase': 6,
    'cycles': 4,
    # safer pruning defaults (less likely to nuke everything quickly)
    'prune_fraction': 0.20,
...
def get_masked_dense_layers(model):
    # model.layers returns all nested layers / sub-layers; use that to discover MaskedDense
